...
export default function NewTemplatePage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      // 1. Create the template first (needed for chat endpoint later)
      ...
      // 4. Build initial AI message summarising what was found
